...
Pocketbyte is a handheld indie computer built on the ESP32-S3 microcontroller. It features a built-in ST7789 display, stereo audio output w/ headphone jack, USB-C 2.0 connectivity, and — most distinctively — a swappable input module system that lets you attach different physical controllers to suit your game or application. 

Instead of locking you into a fixed button layout, Pocketbyte is designed to be hacked, reprogrammed, and reimagined. The software you run on it is entirely your own. And you are free to build your own controller modules, too.
