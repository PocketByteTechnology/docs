...
<Columns cols={2}>
  <Column>
    <Card title="Quickstart" icon="fast-forward">
      Get your toolchain set up and your first app running on the device.
    </Card>
  </Column>
  <Column>
    <Card title="Hardware Overview" icon="circuit-board">
